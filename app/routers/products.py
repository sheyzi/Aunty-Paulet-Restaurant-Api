...
@router.get(
    "/products/featured",
    response_model=List[product_pydantic],
)
async def get_all_featured_products(
...
@router.get(
    "/categories/{slug}", response_model=category_pydantic
)
...
@router.get(
    "/products/{slug}", response_model=product_pydantic
)
